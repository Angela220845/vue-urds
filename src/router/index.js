  ...
  routes: [{
    ...
    },
    {
      ...
      children: [{
        ...
        {
          path: '/mysql_list',
          component: resolve => require(['../components/mysql/mysqlList.vue'], resolve),
          meta: {
            title: 'MySql服务列表'
          }
        ...
        },
        {
          ...
          component: resolve => require(['../components/mysql/mysqlOverview.vue'], resolve),
          meta: {
            title: '概览'
          }
        },
        {
          ...
          component: resolve => require(['../components/mysql/monitor.vue'], resolve),
          meta: {
            title: '监控'
          }
        },
        {
          ...
          component: resolve => require(['../components/mysql/report/report.vue'], resolve),
          meta: {
            title: '巡检报告'
          }
        },
        {
          ...
          component: resolve => require(['../components/mysql/report/diagnosisReport.vue'], resolve),
          meta: {
            title: '巡检报告详情'
          }
        },
        {
          ...
          component: resolve => require(['../components/mysql/backup.vue'], resolve),
          meta: {
            title: '备份集'
          }
        },
        {
          ...
          component: resolve => require(['../components/mysql/paramsChange.vue'], resolve),
          meta: {
            title: '参数变更'
          }
        },
        {
          path: '/mongodb_list',
          component: resolve => require(['../components/mongodb/mongodbList.vue'], resolve),
          meta: {
            title: 'MongoDB服务列表'
          }
        },
        {
          ...
          component: resolve => require(['../components/mongodb/mongodbOverview.vue'], resolve),
          meta: {
            title: '概览'
          }
        },
        {
          ...
          component: resolve => require(['../components/mongodb/monitor.vue'], resolve),
          meta: {
            title: '概览'
          }
        },
        {
          path: '/data_archive',
          component: resolve => require(['../components/dataArchive/dataArchive.vue'], resolve),
          meta: {
            title: '数据归档'
          }
        },
        {
          path: '/log_analysis',
          component: resolve => require(['../components/logAnalysis/logAnalysis.vue'], resolve),
          meta: {
            title: '慢日志分析'
          }
        },
        ...
        {
          path: '/approval',
          component: resolve => require(['../components/approval/approval.vue'], resolve),
          meta: {
            title: '审批'
          }
        },
        {
          path: '/sql/release',
          component: resolve => require(['../components/sql/sqlRelease.vue'], resolve),
          meta: {
            title: 'SQL审核上线'
          }
        },
        {
          path: '/sql/history',
          component: resolve => require(['../components/sql/sqlHistory.vue'], resolve),
          meta: {
            title: '历史记录'
          }
        },
    ...
    {
      path: '/config',
      component: resolve => require(['../components/config/config.vue'], resolve),
      meta: {
        title: '管理页面'
      },
      children: [{
